...
import brandProjectionRoutes from './modules/brand-projection/brand-projection.routes.js';
import materialRequirementRoutes from './modules/material-requirement/material-requirement.routes.js';
import materialPlanRoutes from './modules/material-plan/material-plan.routes.js';
...
app.use('/api/planning/brand-projections', brandProjectionRoutes);
app.use('/api/planning/material-requirements', materialRequirementRoutes);
app.use('/api/planning/material-plans', materialPlanRoutes);
